...
const trackingId = "UniqueTrackingId"; // Genera un ID único para cada correo
...
bulkMessage.setFrom("strategy@gustavoarte.tech"); // Usa setFrom para asignar el remitente
